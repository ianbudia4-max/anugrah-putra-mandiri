...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-navy">
      ...
      <div
        className="pointer-events-none absolute -right-40 -top-40 h-96 w-96 rounded-full bg-blue/20 blur-3xl"
        aria-hidden="true"
      />
      ...
      <div className="container-app relative grid grid-cols-1 items-center gap-10 py-14 sm:py-16 lg:grid-cols-2 lg:gap-12 lg:py-24">
        ...
        >
          ...
          <h1 className="text-balance mt-5 text-3xl font-bold leading-[1.15] tracking-tight text-white sm:text-4xl lg:text-[2.75rem]">
            Produsen Papan Tulis &amp; Papan Tulis Custom di Sukoharjo
          </h1>

          <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-white/70 sm:text-base">
            Anugrah Putra Mandiri merupakan produsen papan tulis di Sukoharjo,
            Jawa Tengah yang menyediakan whiteboard, papan tulis magnetik,
            glassboard, blackboard, dan papan tulis custom untuk sekolah,
            kantor, instansi, ruang meeting, serta berbagai kebutuhan lainnya.
          </p>
        ...
        >
          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] shadow-2xl shadow-black/30">
            <Image
              ...
              alt="Whiteboard magnetik produk Anugrah Putra Mandiri Sukoharjo"
              fill
              priority
